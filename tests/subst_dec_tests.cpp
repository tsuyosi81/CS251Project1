...
const string TEXT_PROMPT = "Enter a string for englishness scoring:";
...
TEST_F(SubstDec_EnglishnessCommandPrompt, CommandPrompt) {
  ...
  ASSERT_THAT(actual_output, HasSubstr(TEXT_PROMPT)) << "\nIncorrect prompt, check above lines to see where the failure occurs and find the correct prompt.";
  ASSERT_THAT(actual_output, HasSubstr("-22.4121")) << "\nIncorrect score";
}
